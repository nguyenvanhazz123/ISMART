...
$(document).ready(function () {
    $('.buyNowToCartBtn').click(function () {     
...
//     var data = {cat_id: cat_id, page: page, r_price: r_price};

//     $.ajax({
//         type: "POST",
//         url: '?mod=product&action=filter_check',
//         data: data,
//         dataType: "json",
//         success: function (data) {                   
...
// })
  ...
  //Update giá tiền bằng ajax trong giở hàng
