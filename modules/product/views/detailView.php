                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">                       
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" style="max-width: 24%" src="admin/<?php echo $item['thumb'] ?>" data-zoom-image="admin/<?php echo $item['thumb'] ?>"/>
                        </a>
                        <div style="margin-top: 285px" id="list-thumb">
                            <a href="" data-image="admin/<?php echo $item['thumb'] ?>" data-zoom-image="admin/<?php echo $item['thumb'] ?>">
                                <img id="zoom" src="admin/<?php echo $item['thumb'] ?>" />
                            </a>
                            <?php 
                            foreach ($list_image as $img) { ?>
                                <a href="" data-image="<?php echo $img['url'] ?>" data-zoom-image="<?php echo $img['url'] ?>">
                                    <img id="zoom" src="<?php echo $img['url'] ?>" />
                                </a>
                            <?php    
                            }
